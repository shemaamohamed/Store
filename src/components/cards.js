   ...
   const navigate =useNavigate();
       ...
       const showcard=(cart)=>{    
        ...
        return(
            ...
            < div onClick={()=>showcard(cart)} class="card" >
            <img  class="card-img"tabindex="0"  src={require(`../assets/${cart.id}.jpg`)} alt="Red t-shirt with a logo" />
            <div  class="card-info">
                <p class="text-title">{cart.title}<small>({cart.size})</small> </p>
            </div>
            <div class="card-footer">
            <span class="text-title">{cart.price}</span>
            {isUser &&  <div class="card-button" >
